...
declare const DeleteSessionCommand_base: {
    new (input: DeleteSessionCommandInput): import("@smithy/core/client").CommandImpl<DeleteSessionCommandInput, DeleteSessionCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSessionCommandInput): import("@smithy/core/client").CommandImpl<DeleteSessionCommandInput, DeleteSessionCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
