...
declare const GetSessionCommand_base: {
    new (input: GetSessionCommandInput): import("@smithy/core/client").CommandImpl<GetSessionCommandInput, GetSessionCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSessionCommandInput): import("@smithy/core/client").CommandImpl<GetSessionCommandInput, GetSessionCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
