...
declare const PutSessionCommand_base: {
    new (input: PutSessionCommandInput): import("@smithy/core/client").CommandImpl<PutSessionCommandInput, PutSessionCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutSessionCommandInput): import("@smithy/core/client").CommandImpl<PutSessionCommandInput, PutSessionCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
