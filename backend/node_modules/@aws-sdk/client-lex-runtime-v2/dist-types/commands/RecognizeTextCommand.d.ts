...
declare const RecognizeTextCommand_base: {
    new (input: RecognizeTextCommandInput): import("@smithy/core/client").CommandImpl<RecognizeTextCommandInput, RecognizeTextCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RecognizeTextCommandInput): import("@smithy/core/client").CommandImpl<RecognizeTextCommandInput, RecognizeTextCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
