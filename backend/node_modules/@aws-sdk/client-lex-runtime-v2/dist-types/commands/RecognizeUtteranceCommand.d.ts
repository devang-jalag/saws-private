...
declare const RecognizeUtteranceCommand_base: {
    new (input: RecognizeUtteranceCommandInput): import("@smithy/core/client").CommandImpl<RecognizeUtteranceCommandInput, RecognizeUtteranceCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RecognizeUtteranceCommandInput): import("@smithy/core/client").CommandImpl<RecognizeUtteranceCommandInput, RecognizeUtteranceCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
