...
declare const StartConversationCommand_base: {
    new (input: StartConversationCommandInput): import("@smithy/core/client").CommandImpl<StartConversationCommandInput, StartConversationCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartConversationCommandInput): import("@smithy/core/client").CommandImpl<StartConversationCommandInput, StartConversationCommandOutput, import("..").LexRuntimeV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
